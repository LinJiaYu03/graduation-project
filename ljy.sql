...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `activity` VALUES (19, 'https://env-00jxuc2o76k9.normal.cloudstatic.cn/1768051923695_0.jpg?expire_at=1768052524&er_sign=1a5dcfc0acc3f9eac38ffcae57abeb68,https://env-00jxuc2o76k9.normal.cloudstatic.cn/1768051923695_1.jpg?expire_at=1768052525&er_sign=a716b0a2492c114aeda14a0b4127397e', '1.10-01', 2, '测试', '体育馆', '12123123', '2026-01-10 21:31:27', '2026-01-11 21:31:47', '2026-01-11 21:31:47', '2026-01-31 21:31:51', 5, 1, 0, '实践实习', '学院', '已结束', 1, '2026-01-10 21:32:21', 8, '2026-01-10 21:32:05', '2026-01-10 21:32:05', '0', 1);
INSERT INTO `activity` VALUES (20, 'https://env-00jxuc2o76k9.normal.cloudstatic.cn/1772008759921_0.jpg?expire_at=1772009442&er_sign=033e70e2f36b0940777875b6a561dac4,https://env-00jxuc2o76k9.normal.cloudstatic.cn/1772008759921_1.jpg?expire_at=1772009442&er_sign=ea88a5ea3bb0a4123c8721971c1534d8', '开学', 1, '开学典礼', '主楼报告厅', '佩戴好校徽', '2026-02-25 16:52:05', '2026-02-25 16:52:05', '2026-02-25 16:52:05', '2026-02-25 16:52:05', 100, 1, 1, '思想成长', '学院', '已结束', 1, '2026-02-25 17:13:01', 8, '2026-02-25 16:40:42', '2026-02-25 16:40:42', '5.0', 1);
INSERT INTO `activity` VALUES (21, 'https://env-00jxuc2o76k9.normal.cloudstatic.cn/1773409615827_0.png?expire_at=1773410348&er_sign=ecd0f24faa2da5a88e78953b23dde599', '迎新晚会', 10, '迎新晚会', '主楼报告厅', '迎新晚会~~~', '2026-03-13 23:57:32', '2026-03-13 23:57:32', '2026-03-13 23:57:32', '2026-03-31 21:46:44', 100, 1, 1, '思想成长', '校级', '进行中', 1, '2026-03-13 23:58:33', 8, '2026-03-13 21:49:08', '2026-03-13 21:49:08', '0', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动签到表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `activity_checkin` VALUES (5, 20, 8, '2026-02-25 17:10:46', '2026-02-25 17:10:45', '2026-02-25 17:10:45');
INSERT INTO `activity_checkin` VALUES (6, 21, 8, '2026-03-13 23:59:43', '2026-03-13 23:59:42', '2026-03-13 23:59:42');
...
CREATE TABLE `activity_registration`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动报名表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `activity_registration` VALUES (25, 20, 8, '已通过', 5.00, '新学期，新气象', 8, '2026-02-25 16:52:01', '2026-02-25 16:51:24', '2026-02-25 16:51:23', '2026-02-25 16:51:23');
INSERT INTO `activity_registration` VALUES (26, 21, 8, '已通过', NULL, NULL, 8, '2026-03-13 23:59:34', '2026-03-13 23:54:11', '2026-03-13 23:54:11', '2026-03-13 23:54:11');
...
CREATE TABLE `club`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_name`(`name` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '社团表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of club
-- ----------------------------
INSERT INTO `club` VALUES (1, 'https://env-00jxuc2o76k9.normal.cloudstatic.cn/buluo.png?expire_at=1765708747&er_sign=f30db4e3eb3a66a4c4cbb9ecd3103eb3', '计算机', '技术,编程,计算机', '致力于计算机技术交流与学习的社团', 1, '2025-12-14 18:09:45', '2026-03-13 21:36:03', '学院');
...
INSERT INTO `club` VALUES (11, 'https://env-00jxuc2o76k9.normal.cloudstatic.cn/club/1773408703099_0r7Dq_m1eYE782c2208f7ee25deef1a74efcb0d310b3.png', '计算机协会', '团支部,传媒,社团与协会', '学习计算机基本知识', 1, '2026-03-13 21:31:47', '2026-03-13 21:31:47', '院级');
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '社团人员表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `club_member` VALUES (20, 11, 26, 'ljy', 0, '2026-03-13 21:37:22', '2026-03-13 21:37:22', '2026-03-13 21:37:22');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (8, 'admin', '1111111', 1, '超级管理员', '202413143500187', 0, '15218786403', '2914288317@qq.com', '广西大学', '电气工程学院', '电气工程2021级1班', '2025-12-14 15:17:42', 1, 'https://env-00jxuc2o76k9.normal.cloudstatic.cn/avatar/1765692890867_wyp.jpg', '95b330c3-b816-46c5-b342-7f834d2b1179', '2025-12-13 00:13:49', '2025-12-14 15:15:15', 1, NULL);
